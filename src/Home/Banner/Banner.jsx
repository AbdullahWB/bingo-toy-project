...
const Banner = () => {
    return (
        <div className='grid grid-cols-4 gap-6 pb-[130px] pt-[50px] px-[20px]'>
            <div className='grid grid-rows-2 gap-6'>
                <div className='grid grid-cols-2 gap-3 bg-[#FAF8F4] p-10 pr-0 items-center'>
                    <div className="text">
                        ...
                        <Link className='btn btn-outline btn-primary'>Shope Now <FaArrowRight className='ml-2'></FaArrowRight></Link>
                    </div>
            ...
            <div className='col-span-2'>
                <div className='h-full bg-[#FFF2DF] p-6 flex flex-col justify-center items-center'>
                    ...
                    <Link className='btn btn-primary mt-10 text-white'>Shope Now <FaArrowRight className='ml-2'></FaArrowRight></Link>
                </div>
            </div>
            <div className='grid grid-rows-2 gap-6'>
